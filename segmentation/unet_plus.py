...
class Unet(nn.Module):
    def __init__(self, n_class, cc=16):
        ...
        self.outconv0 = outconv(cc, n_class)
        self.outconv1 = outconv(cc, n_class)
        self.outconv2 = outconv(cc, n_class)
        self.outconv3 = outconv(cc, n_class)
        self.outconv = nn.Conv2d(n_class * 4, n_class, kernel_size=1)
